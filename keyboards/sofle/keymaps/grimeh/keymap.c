 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI |  \   | LAlt | LCTR | /Space  /       \LAYER1\  |LAYER2| [    | ]    | EQUAL|
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_LAYER0] = LAYOUT( \
    ...
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,  KC_MUTE,  KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_ENTER, \
                 KC_LGUI,KC_BSLASH,KC_LALT, KC_LCTRL, KC_SPC,      MO(_LAYER1),  MO(_LAYER2), KC_LBRC, KC_RBRC, KC_EQUAL \
),
...
[_LAYER1] = LAYOUT( \
    ...
    _______, KC_LPRN, KC_LBRC, KC_RBRC, KC_RPRN, _______,                   _______,    KC_7,    KC_8,    KC_9, _______, _______, \
...
[_LAYER2] = LAYOUT( \
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, \
    _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4, _______,                   _______, KC_HOME,   KC_UP,  KC_END, _______,  KC_DEL, \
...
static void print_status_narrow(void) {
    ...
    switch (get_highest_layer(default_layer_state)) {
        case _LAYER0:
            oled_write_ln_P(PSTR("LYR0"), false);
            break;
        case _LAYER1:
            oled_write_ln_P(PSTR("LYR1"), false);
            break;
        default:
